...
namespace MyTagPocket.Dal.Upgrade
{
  ...
  public class UpgradeDb : IUpgradeDb
  {
    ...
    public UpgradeDb(SQLiteConnection conn)
    {
      db = conn;
    }
    ...
    public void CheckAndUpgrade()
    {
      ...
      Log.Trace(methodCode, "Start CheckAndUpgrade");
      CheckAndUpgrade(new TableVersion());
      Log.Trace(methodCode, "End CheckAndUpgrade");
    }
    ...
    private bool IsExistsTable<T>() where T : class
    {
    ...
    /// <typeparam name="T">Class of Table</typeparam>
    /// <returns></returns>
    private void CreateTable<T>() where T : class
    {
    ...
    /// <returns></returns>
    private bool IsTypeExistst(string type, string name)
    {
    ...
    /// Check TableVersion
    /// </summary>
    private void CheckAndUpgrade(TableVersion table)
    {
